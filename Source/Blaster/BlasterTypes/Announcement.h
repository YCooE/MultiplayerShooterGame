...
{
	const FString NewMatchStartsIn(TEXT("New soot match starts in:"));
	...
	const FString RedTeamWins(TEXT("Red team wins the sooting!"));
	const FString BlueTeamWins(TEXT("Blue team wins the sooting!"));
}